...
// JavaScript function for logout and redirect
function logoutAndRedirect() {
    // Perform logout logic here, e.g., clearing session or token
    console.log("User logged out successfully.");

    // Redirect to the profile page
    window.location.href = '../public/profile.html'; // Update with the actual URL of your profile page
}

// Example usage: Attach the function to a button
document.getElementById('logoutButton').onclick = logoutAndRedirect;
